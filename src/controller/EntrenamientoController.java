...
public class EntrenamientoController {
    ...
    // M�todo que gestiona la l�gica de los ataques cuando un Pok�mon es el primero en atacar
    ...
    // M�todo que maneja el caso cuando ambos Pok�mon tienen la misma velocidad
